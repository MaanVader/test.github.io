...
if(isset($_POST['update'])){
    ...
    $adminUpPro=mysqli_query($con,"select * from user where user_email='$email' and user_role = 'employee'");
    $checkECNum=mysqli_num_rows($adminUpPro);
    if($checkECNum==1){
        $adminUp = mysqli_query($con, "UPDATE user SET user_name= '$name',user_email= '$email',user_phone_num='$phone', user_password='$password' where user_email='$Email'");
...
?>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand mr-5" href="index.php">Software Security Readiness Index</a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <!-- <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <?php echo $Email; ?></a>
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                       ...
                       <input type="hidden" name="User_Id" value="<?php echo $run['user_id'];?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="exampleInputEmail2" aria-describedby="emailHelp" placeholder="Enter name" value="<?php echo $run['user_name'];?>" required>
